...
public class LNQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LNQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LNQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LNQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LNQDateTimeConverter dateTimeConverter = new LNQStandardDateTimeConverter();

    public LNQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LNQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LNQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LNQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LNQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LNQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
