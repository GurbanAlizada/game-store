...
public class LNQKPSPublicSoap
{
    ...
    public LNQKPSPublicSoap(){}

    public LNQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LNQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LNQExtendedSoapSerializationEnvelope envelope= new LNQExtendedSoapSerializationEnvelope(LNQExtendedSoapSerializationEnvelope.VER11);
